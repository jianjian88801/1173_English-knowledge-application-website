...
public class PeixunbaomingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,PeixunbaomingEntity peixunbaoming,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			peixunbaoming.setZhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,PeixunbaomingEntity peixunbaoming, 
		HttpServletRequest request){
        EntityWrapper<PeixunbaomingEntity> ew = new EntityWrapper<PeixunbaomingEntity>();
		PageUtils page = peixunbaomingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, peixunbaoming), params), params));
        return R.ok().put("data", page);
